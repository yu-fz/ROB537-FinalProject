...
class Explore2DTrial_Env(gym.Env):
    ...
    def __init__(self, **kwargs):
        ...
        self.agentMapHeight = 2*self.detectionRadius+1 
        ...
        # why not just current observation was chosen?
        self.observation_space = spaces.Dict({
            "AgentMap": spaces.Box(low = 0, high = 3, shape = (3,3,3)), 
    ...
    def spawnAgent(self):
        ...
        for i in range(2):
            coordList.append(random.randint(1, self.shape[0]-2)) # why -2?
    ...
    def getState(self): # input to the neural network
    ...
    def returnExplorationProgress(self):
        ...
        #print ("Percentage covered: ", exploreFrac * 100)
        return exploreFrac
